class AppImageAsset {
  ...
  static const String category = "$rootImages/application.png";
  static const String items = "$rootImages/product.png";
  static const String orders = "$rootImages/received.png";
